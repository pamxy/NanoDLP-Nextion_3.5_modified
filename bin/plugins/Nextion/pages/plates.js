            ...
            switch (_context.prev = _context.next) {
              ...
              case 8:
                ...
                this.addListener("click_b10", function (e) {
                  if (_this2.currentIndex + 5 < _this2.plates.length) _this2.changePage("plate", _this2.plates[_this2.currentIndex + 5]);
                });
                this.addListener("click_b11", function (e) {
                  if (_this2.currentIndex + 6 < _this2.plates.length) _this2.changePage("plate", _this2.plates[_this2.currentIndex + 6]);
                });

                gap = 100 / (this.plates.length - 6);


                this.addListener("number", function (scroll) {
                  scroll = Math.floor((100 - scroll) / gap);
                  if (scroll <= _this2.plates.length - 7) _this2.updateList(scroll);
                });
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                this.setText("b10", index + 6 + ". " + this.plates[index + 5].Path);
                this.setText("b11", index + 7 + ". " + this.plates[index + 6].Path);
