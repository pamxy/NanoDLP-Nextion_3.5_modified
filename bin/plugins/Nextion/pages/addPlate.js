                  ...
                  switch (_context.prev = _context.next) {
                     ...
                     case 32:
                        ...
                        this.addListener("number", function (scroll) {
                           idxF = Math.floor((100 - scroll) / (100 / (fin.length - 5)));
                           if (idxF <= fin.length - 6) _this2.list(idxF, fin);
                        });
                        ...
                        this.addListener("click_b14", function (e) {
                           if (idxF + 4 < fin.length && _this2.evalFile(fin[idxF + 4])) _this2.changePage("confirm", {
                              text: "Are you sure you want to create\rthe following new plate?\r\rProfile: " + _this2.profiles[idxP].Title + "\rPath: " + pth[idxD] + "\rFile: " + fin[idxF + 4],
                              confirmType: "addplate",
                              returnPage: "addPlate",
                              data0: _this2.profiles[idxP].ProfileID,
                              data1: pth[idxD],
                        ...
                        this.addListener("click_b15", function (e) {
                           if (idxF + 5 < fin.length && _this2.evalFile(fin[idxF + 5])) _this2.changePage("confirm", {
                              text: "Are you sure you want to create\rthe following new plate?\r\rProfile: " + _this2.profiles[idxP].Title + "\rPath: " + pth[idxD] + "\rFile: " + fin[idxF + 5],
                              confirmType: "addplate",
                              returnPage: "addPlate",
                              data0: _this2.profiles[idxP].ProfileID,
                              data1: pth[idxD],
               ...
               while (1) {
                  switch (_context2.prev = _context2.next) {
                     case 0:
                        ...
                        if (fin.length > 4) {
                           this.setText("b14", fin[index + 4]);
                        } else {
                           this.setText("b14", "");
                        }
                        if (fin.length > 5) {
                           this.setText("b15", fin[index + 5]);
                        } else {
                           this.setText("b15", "");
                        }
